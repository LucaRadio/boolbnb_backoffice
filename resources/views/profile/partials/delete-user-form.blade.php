<section class="space-y-6">
    <header>
        <h2 class="text-lg font-medium text-gray-900">
            {{ __('Cancellazione Account') }}
        </h2>

        <p class="mt-1 text-sm text-gray-600">
            {{ __('Una volta che il tuo account sarà cancellato, i tuoi dati saranno cancellati definitivamente. Prima di cancellare il tuo account,ti consigliamo quindi di scaricarti i dati che vuoi mantenere') }}
        </p>
    </header>
